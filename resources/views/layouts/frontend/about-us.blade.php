...
<section class="aboutus-section spad">
    <div class="container">
        <div class="aboutus-page-text">
            ...
            <img src="{{url('assets/frontendimg/about-us.jpg')}}">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-us">
                        <h4>ABOUT US</h4>
...
<section class="testimonial-section set-bg spad" data-setbg="{{url('assets/frontendimg/testimonial-bg.jpg')}}">
    <div class="container">
        <div class="row">
                ...
                <div class="testimonial-slider owl-carousel">
                    <div class="ts-item">
                        ...
                        <div class="author-pic">
                            <img src="{{url('assets/frontendimg/author-pic.png')}}">
                        </div>
                    </div>
                    <div class="ts-item">
                        <div class="rating">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="trainer-item">
                    <div class="ti-pic">
                        <img src="{{url('assets/frontendimg/trainer/trainer-1.jpg')}}">
                        <div class="ti-links">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="trainer-item">
                    <div class="ti-pic">
                        <img src="{{url('assets/frontendimg/trainer/trainer-2.jpg')}}">
                        <div class="ti-links">
                            <a href="#"><i class="fa fa-facebook"></i></a>
                            <a href="#"><i class="fa fa-pinterest"></i></a>
                            <a href="#"><i class="fa fa-linkedin"></i></a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="trainer-item">
                    <div class="ti-pic">
                        <img src="{{url('assets/frontendimg/trainer/trainer-3.jpg')}}">
                        <div class="ti-links">
                            <a href="#"><i class="fa fa-facebook"></i></a>
                            <a href="#"><i class="fa fa-pinterest"></i></a>
                            <a href="#"><i class="fa fa-linkedin"></i></a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="trainer-item">
                    <div class="ti-pic">
                        <img src="{{url('assets/frontendimg/trainer/trainer-4.jpg')}}">
                        <div class="ti-links">
                            <a href="#"><i class="fa fa-facebook"></i></a>
                            <a href="#"><i class="fa fa-pinterest"></i></a>
                            <a href="#"><i class="fa fa-linkedin"></i></a>
