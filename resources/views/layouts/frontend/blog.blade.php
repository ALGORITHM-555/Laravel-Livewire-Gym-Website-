...
<section class="blog-single-hero set-bg" data-setbg="{{url('assets/frontendimg/blog-single-hero.jpg')}}">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="blog-single-text">
                    ...
                    <div class="blog-pic">
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="{{url('assets/frontendimg/blog-single-1.jpg')}}">
                            </div>
                            <div class="col-lg-6">
                                <img src="{{url('assets/frontendimg/blog-single-2.jpg')}}">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <img src="{{url('assets/frontendimg/blog-single-3.jpg')}}">
                                    </div>
                                    <div class="col-sm-6">
                                        <img src="{{url('assets/frontendimg/blog-single-4.jpg')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="blog-single-sidebar">
                    <div class="bs-latest-news">
                        <h4>News Latest</h4>
                        <a href="#" class="bl-item set-bg" data-setbg="{{url('assets/frontendimg/sidebar-latest.jpg')}}">
                    ...
                    <div class="bs-recent-news">
                        ...
                        <a href="#" class="br-item">
                            <div class="bi-pic">
                                <img src="{{url('assets/frontendimg/br-recent-1.jpg')}}">
                            </div>
                            <div class="bi-text">
                        ...
                        <a href="#" class="br-item">
                            <div class="bi-pic">
                                <img src="{{url('assets/frontendimg/br-recent-2.jpg')}}">
                            </div>
                            <div class="bi-text">
                                <span>Jan 31, 2019</span>
                        ...
                        <a href="#" class="br-item">
                            <div class="bi-pic">
                                <img src="{{url('assets/frontendimg/br-recent-3.jpg')}}">
                            </div>
                            <div class="bi-text">
                                <span>Jan 31, 2019</span>
                        ...
                        <a href="#" class="br-item">
                            <div class="bi-pic">
                                <img src="{{url('assets/frontendimg/br-recent-4.jpg')}}">
                            </div>
                            <div class="bi-text">
                                <span>Jan 31, 2019</span>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="recent-news">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="recent-item set-bg" data-setbg="{{url('assets/frontendimg/recent-1.jpg')}}">
                        ...
                        <div class="col-lg-4">
                            <div class="recent-item set-bg" data-setbg="{{url('assets/frontendimg/recent-2.jpg')}}">
                                <a href="#" class="recent-text">
                                    <div class="categories">Gym & Croosfit</div>
                                    <h5>Many people sign up for affiliate programs</h5>
                                </a>
                        ...
                        <div class="col-lg-4">
                            <div class="recent-item set-bg" data-setbg="{{url('assets/frontendimg/recent-3.jpg')}}">
                                <a href="#" class="recent-text">
                                    <div class="categories">Gym & Croosfit</div>
                                    <h5>Many people sign up for affiliate programs</h5>
                                </a>
