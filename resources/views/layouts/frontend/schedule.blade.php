...
<section class="breadcrumb-section set-bg spad" data-setbg="{{url('assets/frontendimg/about-bread.jp')}}g">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<section class="classes-section schedule-page">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3">
                <div class="classes-item set-bg" data-setbg="{{url('assets/frontendimg/classes/class-1.jp')}}g">
            ...
            <div class="col-lg-3">
                <div class="classes-item set-bg" data-setbg="{{url('assets/frontendimg/classes/class-2.jp')}}g">
                    <h4>BootCamp</h4>
            ...
            <div class="col-lg-3">
                <div class="classes-item set-bg" data-setbg="{{url('assets/frontendimg/classes/class-3.jp')}}g">
                    <h4>Energy Blast</h4>
            ...
            <div class="col-lg-3">
                <div class="classes-item set-bg" data-setbg="{{url('assets/frontendimg/classes/class-4.jp')}}g">
